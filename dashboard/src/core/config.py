...
        Supports $ENV_VAR and ${ENV_VAR} expansion in the workspace field."""
        workspace = os.path.expandvars(self.workspace)
        p = Path(relative)
        if p.is_absolute():
            return relative
...
    cfg.telemetry.bus_dir = cfg.resolve_path(cfg.telemetry.bus_dir)
    cfg.openspec.changes_dir = cfg.resolve_path(cfg.openspec.changes_dir)
    cfg.openspec.schemas_dir = cfg.resolve_path(cfg.openspec.schemas_dir)
    return cfg
